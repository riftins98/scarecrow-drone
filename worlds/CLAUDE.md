...
- `hangar_1.sdf` — Large indoor hangar world with checkerboard floor, landing pads, perimeter walls, ceiling beam/net structure, roof panels, debris, lights, military drone props, pigeon target, and fixed `mono_cam_hd` observer cameras.
