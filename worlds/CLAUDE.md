...
- `hangar_lite.sdf` — Simplified 24m x 15m x 8m hangar shell with plain floor, flat ceiling, and plain perimeter walls. No windows, columns, beams, props, or targets; includes lights and fixed `mono_cam_hd` observer cameras.
