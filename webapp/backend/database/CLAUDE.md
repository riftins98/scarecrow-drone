...
- `flights` — id TEXT PK, area_map_id FK (nullable), start_time, end_time, duration, pigeons_detected, pigeons_deterred, pursuit_flow_count, frames_processed, status, video_path, map_path
