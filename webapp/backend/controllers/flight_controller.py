...
async def flight_log(since: int = 0):
    """Return flight-script stdout lines with absolute index >= since.

    Polled by the frontend SystemLog after the sim is connected so operators
    see mission output instead of the PX4/Gazebo launcher log.
    """
