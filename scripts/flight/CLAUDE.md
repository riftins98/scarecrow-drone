...
- `ceiling_clearance_flight.py` — Upward rangefinder flight test for roofed worlds: takeoff to 2.5m AGL, lidar-stabilize, climb slowly until the ceiling sensor reads 1.5m clearance, hover, descend until the ceiling sensor reads 2.5m clearance, hover, then lidar-assisted land. Logs ceiling clearance continuously during climb/hover/descent/landing.
